		...
		function cargarprogramas2(page){
			$.ajax({
				url:'panel/ajax/selectbox.php',
				 beforeSend: function(objeto){
				...
				success:function(data){
					$("#cargar_datos_box22").html(data);
					$(".cargar_datos_box22").html(data).fadeIn('slow');
					$("#cargar_datos_boxx").html("");
				}
			})
		}
		...
		$( "#add_product2" ).submit(function( event ) {
		  var parametros = $(this).serialize();
			$.ajax({
					type: "POST",
					url: "panel/ajax/guardar_programains.php",
					data: parametros,
					 beforeSend: function(objeto){
						$("#resultados").html("Enviando...");
					  },
